...
class hog :
    ...
    def __init__(self):
        ...
        self.probabiltes = generate_P_matrix(D_MAX)
        self.eg,self.opt = esperance_gain(SCORE_MAX,D_MAX,self.probabiltes)
    ...
    def jouer(self,strategie0, strategie1, but = SCORE_MAX):
